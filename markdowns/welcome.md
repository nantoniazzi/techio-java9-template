...
The source code is on [GitHub](https://github.com/nantoniazzi/techio-java9-template), please feel free to come up with proposals to improve it.
...
Check out the markdown file [`welcome.md`](https://github.com/nantoniazzi/techio-java9-template/blob/master/markdowns/welcome.md) to see how this exercise is injected into the template.

# Template Resources

[`markdowns/welcome.md`](https://github.com/nantoniazzi/techio-java9-template/blob/master/markdowns/welcome.md)
What you are reading here is generated by this file. Tech.io uses the [Markdown syntax](https://tech.io/doc/reference-markdowns) to render text, media and to inject programming exercises.


[`java-project`](https://github.com/nantoniazzi/techio-java9-template/tree/master/java-project)
...
[`techio.yml`](https://github.com/nantoniazzi/techio-java9-template/blob/master/techio.yml)
